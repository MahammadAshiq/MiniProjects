...
function doLogin() {
  ...
  document.getElementById('success-sub').textContent = 'You are now logged in. A Student dashboard is coming soon.';
...
function showComingSoon() {
  ...
  toast.textContent = '🦠 Disease Detection is coming soon — photo-based crop disease scanning is in the works!';
